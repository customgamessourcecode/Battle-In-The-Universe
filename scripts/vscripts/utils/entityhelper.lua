...
---在地图上某个实体点的位置显示提示信息
function m.ShowOnMiniMap(unitOrPos)
	if unitOrPos.entindex then
		SendToAllClient("custom_ping_minimap",{unit=unitOrPos:entindex()})
	else
		SendToAllClient("custom_ping_minimap",{loc=unitOrPos})
	end
end
